...
try:
    ...
    full_name_field.send_keys("Peter Parker")

    # Находим поле Email по его ID и вводим текст
    email_field = driver.find_element(By.ID, "userEmail")
    email_field.send_keys("aishams83mail.ru")
    ...
    # Находим поле Current_Adress по его ID и вводим текст
    current_field = driver.find_element(By.ID, "currentAddress")
    current_field.send_keys("Boston")

    # Находим поле Permanent_Adress по его ID и вводим текст
    permanent_field = driver.find_element(By.ID, "permanentAddress")
    permanent_field.send_keys("Moscow")
    ...
    assert "Peter Parker" in result_box.text
